...
$config = array(
	...
	'fosuserbundle-sql' => array(
		...
		'username' => 'npprofile',
		'password' => 'rahasiaya!',
		'query' => 'SELECT username, email FROM negeripelangi_user WHERE username = :username  AND password = :password',
	),
	...
	*/
	...
	'example-ldap' => array(
		...
		'dnpattern' => 'uid=%username%,ou=Users,dc=openthinklabs,dc=com',
		...
		'search.base' => 'ou=Users,dc=openthinklabs,dc=com',
